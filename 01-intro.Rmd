...
```{r framework, echo=FALSE,fig.cap="Elements of data analysis and modeling framework, Vodovotz et al.", out.width='50%', fig.align='center'}
knitr::include_graphics("figures/Fig1_Elements.png")
```
...
```{r approach, echo=FALSE,fig.cap="Approach: Data and information flow in the iterative analysis platform", out.width='70%',fig.align='center'}
knitr::include_graphics("figures/Fig2_Approach.png")
```
...
```{r schedule, echo=FALSE,fig.cap="Table 1", out.width='70%', fig.align='center'}
knitr::include_graphics("figures/Fig3_Schedule.png")
```
